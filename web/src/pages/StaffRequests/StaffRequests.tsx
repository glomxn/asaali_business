    ...
    if (qq) {
      arr = arr.filter(
        (r) =>
          ...
          r.identifier.toLowerCase().includes(qq)
      );
    }
    if (statusFilter !== 'all') {
  ...
  return (
    <div className={styles.page}>
      <div className={styles.head}>
        <div>
          <div className={styles.h1}>🛡️ Demandes staff</div>
          <div className={styles.h2}>
            Gérez les demandes de création d'entreprise. {pendingCount > 0 && (
      ...
      <div className={styles.filters}>
        <input
          ...
          placeholder="Rechercher (nom / lieu / type / identifier)"
          value={q}
          ...
          >
            <div className={styles.top}>
              <div>
                ...
                <div className={styles.identifier}>ID: {req.identifier}</div>
              </div>
            ...
            {req.staffComment && (
              <div className={styles.comment}>
                <strong>Commentaire:</strong> {req.staffComment}
              </div>
            )}
          </button>
        ))}
